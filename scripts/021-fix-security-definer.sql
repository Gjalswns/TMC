-- =====================================================
-- 021: Fix Security Definer Views
-- =====================================================
-- Remove SECURITY DEFINER from views for better security
-- =====================================================

-- Drop and recreate v_lock_conflicts without SECURITY DEFINER
DROP VIEW IF EXISTS v_lock_conflicts;
...
-- Grant limited access (read only)
